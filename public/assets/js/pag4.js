...
const playButton_7 = document.getElementById('play_paso_7');
const audio_paso_7 = document.getElementById('audio_paso_7');
...
playButton_7.addEventListener('click', () => {
    if (audio_paso_7.paused) {
        audio_paso_7.play();
        // Si deseas cambiar el ícono a pausa:
        playButton_7.querySelector('.fa-play').classList.add('fa-pause');
    } else {
        audio_paso_7.pause();
        // Si deseas cambiar el ícono a play:
        playButton_7.querySelector('.fa-play').classList.remove('fa-pause');
    }
});
